...
const Vision = () => {
    ...
    function likePost() {
        ...
        const likedByNode = ref(database, `frame-the-vision/examplePosts/${id}/likedBy/${userId}`)
        setLiked(true)
        set(likedByNode, true).then(() => {
            const likedCounterNode = ref(database, `frame-the-vision/examplePosts/${id}/likedCounter`)
    ...
    useEffect(() => {
        const database = getDatabase(app)
        const postNode = ref(database, `frame-the-vision/examplePosts/${id}`)
